...
const getBreadcrumbTitle = (pathname) => {
  const map = {
    ...
    '/complaints': { title: 'Grievance & Helpdesk Portal', section: 'Campus' },
    ...
    '/settings': { title: 'System Settings & Preferences', section: 'Account' },
    '/faculty': { title: 'Faculty Operations Console', section: 'Role Portal' },
    '/admin': { title: 'University Admin Control Center', section: 'Role Portal' }
  };
  return map[pathname] || { title: 'UniFlow X Shell', section: 'App' };
};
